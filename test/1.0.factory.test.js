...
describe('Factory', function () {
    ...
    it('Should upgrade all forward impl once upgrade forward', async () => {
        ...
        let factory_childImplementation = await factory.childImplementation()
        console.log(
            'factory.childImplementation(): ',
            factory_childImplementation
        )
        ...
        await factory.upgradeChildTo(forward721v1_1.address)
